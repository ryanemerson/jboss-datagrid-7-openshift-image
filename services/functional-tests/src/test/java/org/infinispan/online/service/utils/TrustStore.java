...
public class TrustStore {
   ...
   private void create() {
      assert client != null;
      assert client.secrets() != null;
      assert client.secrets().withName("service-certs") != null;
      assert client.secrets().withName("service-certs").get() != null;
      assert client.secrets().withName("service-certs").get().getData() != null;
